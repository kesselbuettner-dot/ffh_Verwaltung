...
3. Mitglied öffnet auf dem Smartphone einen eigenen befristeten Prüfauftrag, fotografiert den Führerschein; Bilddaten bleiben nach Möglichkeit ausschließlich im Arbeitsspeicher während des Prüfablaufs. Name und erforderliche Nummer/letzte Stellen werden mit zugeordneten Stammdaten abgeglichen. Rein automatische Texterkennung kann fehlschlagen und ist keine sichere Echtheits- oder Identitätsprüfung. Positiver Status erst nach verlässlich gestalteter Prüfung oder autorisierter manueller Bestätigung; Abweichung → Prüfung offen/manuell klären.
