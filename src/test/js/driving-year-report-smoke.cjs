...
for(const asset of ['print-templates.js?v=1','print-templates.css?v=1','print-reports.js?v=1'])
 assert(html.includes('/'+asset)&&sw.includes('/'+asset),'Template asset not loaded and precached: '+asset);
assert(html.includes('/wehrleiter.js?v=6')&&sw.includes('/wehrleiter.js?v=6'),'Driver report script not refreshed');
