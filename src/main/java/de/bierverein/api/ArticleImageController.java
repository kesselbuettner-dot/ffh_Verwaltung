...
public class ArticleImageController {
 ...
 public Map<String,String> upload(@PathVariable Long id,@RequestPart("file") MultipartFile file)throws IOException{
  ...
  String ext=switch(type){case "image/png"->".png";case "image/webp"->".webp";case "image/gif"->".gif";default->".jpg"}; String stored=id+"-"+UUID.randomUUID()+ext; Files.copy(file.getInputStream(),storage.resolve(stored),StandardCopyOption.REPLACE_EXISTING);
