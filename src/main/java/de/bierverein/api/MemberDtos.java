...
public final class MemberDtos { private MemberDtos(){}
 public record MemberResponse(Long id,String name,String email,String phone,String address,boolean active,BigDecimal balance,Long userId,String username,Role role,boolean loginEnabled){}
