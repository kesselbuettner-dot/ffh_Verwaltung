...
public class TrainingScheduleEvent {
    ...
    // Wrapper types keep Hibernate ddl-auto=update compatible with existing rows.
    private Boolean lastWeekdayOfMonth = false;
    ...
    private Boolean deviceInspection = false;
    ...
    public boolean isLastWeekdayOfMonth(){return Boolean.TRUE.equals(lastWeekdayOfMonth);} public void setLastWeekdayOfMonth(boolean v){lastWeekdayOfMonth=v;}
