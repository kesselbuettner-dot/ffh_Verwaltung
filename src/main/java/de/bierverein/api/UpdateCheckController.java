...
public class UpdateCheckController {
    ...
    public UpdateDto check() {
        try {
            ...
            JsonNode release = RestClient.builder()
            ...
            if (release == null) {
                throw new IllegalStateException("GitHub hat keine Release-Daten geliefert.");
            }
            ...
            if (remoteVersion.isBlank()) {
                throw new IllegalStateException("GitHub-Release enthält kein gültiges tag_name.");
            }
            ...
            return new UpdateDto(
                    ...
                    available,
                    available
                            ? "Eine neue veröffentlichte Version ist auf GitHub vorhanden."
                            : "Die installierte Version ist aktuell.",
                    "https://github.com/" + repository,
                    updaterToken != null && !updaterToken.isBlank());
        } catch (ResponseStatusException e) {
            throw e;
        } catch (Exception e) {
            throw new ResponseStatusException(
                    HttpStatus.BAD_GATEWAY,
                    "GitHub konnte nicht geprüft werden: " + safeMessage(e),
                    e);
        }
    }
    ...
    public ResponseEntity<UpdateStartDto> install() {
        ...
        if (!check.updateAvailable()) {
            return ResponseEntity.status(HttpStatus.CONFLICT)
                    .body(new UpdateStartDto(false, "Kein neues Release verfügbar."));
        }
        ...
        try {
            ...
            return ResponseEntity.accepted()
                    .body(new UpdateStartDto(
                            true,
                            "Update wurde auf dem Server gestartet. Die Anwendung wird gleich neu gestartet."));
        } catch (Exception e) {
            throw new ResponseStatusException(
                    HttpStatus.BAD_GATEWAY,
                    "Update-Server konnte nicht erreicht werden: " + safeMessage(e),
                    e);
        }
    }
    ...
    private int compareVersions(String a, String b) {
        try {
            ...
            // Fall back to lexical comparison for malformed version strings.
        }
